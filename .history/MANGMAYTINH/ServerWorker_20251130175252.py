    ...
    def processRtspRequest(self, data):
        ...
        if requestType == self.SETUP:
            if self.state == self.INIT:
                ...
                # Parse RTP port correctly from Transport line
                # Example line: "Transport: RTP/UDP; client_port=5004"
                transport_line = request[2].strip()
                rtp_port_part = transport_line.split("client_port=")[1]
                self.clientInfo['rtpPort'] = int(rtp_port_part)

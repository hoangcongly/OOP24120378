...
{
private: 
    static SortAlgorithm* _algorithm;// lưu đối tượng duy nhất của lớp
    void (*currentAlgorithm)(float[], int); // lưu thuật toán được chọn
    SortAlgorithm();
public:     
...
int main()
{
    float a[]= {1.4F,-5.2F, 3.3F,1 ,4,2,8, 0,9,45};

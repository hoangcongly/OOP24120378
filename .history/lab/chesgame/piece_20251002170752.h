...
private:
    sf::Sprite m_sprite;
    sf::Texture m_texture;  // texture riêng của từng quân cờ
...
public:
    // Constructor mặc định: khởi tạo type, player, position, moved
    ...
    {
        setTexture(); // gán texture sau khi khởi tạo các thuộc tính
    }
